...
./scripts/multiclass.py ./cfk/X1/info/default.cfg [-Psenuse=SENUSE] [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]
./scripts/multiclass.py ./cfk/X2/info/default.cfg [-Psenuse=SENUSE] [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]
./scripts/multiclass.py ./cfk/X3/info/default.cfg [-Psenuse=SENUSE] [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]

The following commands print the results of the evaluation:

./scripts/multiclass_res.py ./cfk/X1/info/default.cfg {RES-FILES}
./scripts/multiclass_res.py ./cfk/X2/info/default.cfg {RES-FILES}
./scripts/multiclass_res.py ./cfk/X3/info/default.cfg {RES-FILES}
...
./scripts/multiclass.py ./als/common/info/default.cfg [-Psenuse=SENUSE] [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]

The following command print the results of the evaluation:

./scripts/multiclass_res.py ./als/common/info/default.cfg {RES-FILES}
...
./scripts/oneclass_ubm.py ./als/oneclass/info/default.cfg [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]
./scripts/oneclass_ubm.py ./cfk/X1-oneclass/info/default.cfg [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]
./scripts/oneclass_ubm.py ./cfk/X2-oneclass/info/default.cfg [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]
./scripts/oneclass_ubm.py ./cfk/X3-oneclass/info/default.cfg [-Pfeause=FEAUSE] [-Pclsuse=CLSUSE]

The following command print the results of the evaluation:

./scripts/oneclass_prob_res.py ./als/oneclass/info/default.cfg {RES-FILES}
./scripts/oneclass_prob_res.py ./cfk/X1-oneclass/info/default.cfg {RES-FILES}
./scripts/oneclass_prob_res.py ./cfk/X2-oneclass/info/default.cfg {RES-FILES}
./scripts/oneclass_prob_res.py ./cfk/X3-oneclass/info/default.cfg {RES-FILES}
