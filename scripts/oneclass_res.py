...
if len(sys.argv) < 2:
    raise ValueError("Usage: "+sys.argv[0]+" CFG prob_*.npy")
# if sys.argv[1]=='csv':
...
for fn in sorted(fns):
    ...
    oklb = lcls[0]
    eer, cm = icls.eer(prob, flst=ftest, okpat=oklb)
